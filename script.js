document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleFocusOut(event) {
        ...
        focusOutTimer = setTimeout(() => {
            ...
            if (newActiveElement === ghostSpan) return;
    ...
    function acceptSuggestion() {
        ...
        const originalScrollTop = currentActiveElement.scrollTop || 0;
        const originalScrollLeft = currentActiveElement.scrollLeft || 0;
        ...
        } else if (currentActiveElement.getAttribute("contenteditable") === "true") {
            currentActiveElement.innerText = fullCode;
            const range = document.createRange();
            const sel = window.getSelection();
            range.selectNodeContents(currentActiveElement);
